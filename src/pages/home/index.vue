<template>
  ...
  <van-swipe class="my-swiper" height="170" :autoplay="3000" lazy-render indicator-color="white">
    <van-swipe-item v-for="item in homeData.slides" :key="item.id">
      <van-image radius="5" height="100%" fit="contain" :src="item.pic_image_url
        " />
    </van-swipe-item>
  </van-swipe>
  ...
  >
    <van-col span="6">
      <van-image :src="item.avatar_url" width="100" height="100" />
    </van-col>
